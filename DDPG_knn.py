...
agent = DDPG(state_dim=len(train_id) + 1, action_dim=int(output_action_dim), action_bound=output_action_bound,
             max_seq_length=MAX_SEQ_LENGTH, critic_lr=1e-4, actor_lr=1e-4, hidden_size=300)
...
pickle.dump(actor_loss_list, open('actor_loss', mode='wb'))
pickle.dump(critic_loss_list, open('critic_loss', mode='wb'))
